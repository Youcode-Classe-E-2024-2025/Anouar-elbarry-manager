...
<div class="hidden pt-14 Addproduct_modal h-screen sm:ml-64 overflow-x-auto shadow-md sm:rounded-lg px-8">
        ...
        <form action="./../src\Controllers\product_Controler.php" method="POST">
            <div class="mb-4">
            ...
            <div class="mb-4">
                <label for="supplierpr" class="block text-gray-700 font-medium mb-2">supplier</label>
                <select name="supplierpr" id="supplierpr"  class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
            ...
            <div class="mb-4">
                <label for="CategoryPr" class="block text-gray-700 font-medium mb-2">Category</label>
                <select name="CategoryPr" id="CategoryPr"  class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                <option value="choose a supplier" selected>choose a supplier</option>
                    <?php
                ...
                while ($option = $result->fetch_assoc()) {
                    echo "
                   <option id='$option[category_name]'>$option[category_name]</option>
                    ";
                }
                ?>
                </select>
