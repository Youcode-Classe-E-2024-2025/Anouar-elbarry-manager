<div class="hidden pt-14 addcategory_modal h-screen sm:ml-64 overflow-x-auto shadow-md sm:rounded-lg px-32">
        ...
        <form action="./../src\Controllers\category_Controller.php" method="POST">
            <div class="mb-4">
            ...
            <div class="mb-4">
                <label for="productNbr" class="block text-gray-700 font-medium mb-2">products Nbr</label>
                <input type="number" id="productNbr" name="productNbr" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
            </div>
